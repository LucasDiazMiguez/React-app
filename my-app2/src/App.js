  ...
  useEffect(() => {
    const buscoItems = new Promise((resolve, reject) => {
      ...
      const producto9 = new Products(
        "$4.999",
        1,
        "../imagenes/imagenesInicio/camara-destacada.webp",
      ...
      const producto10 = new Products(
        "$15.999",
        20,
        "../imagenes/imagenesInicio/gabinetegamer.webp",
      ...
      const producto11 = new Products(
        "$150.999",
        10,
        "../imagenes/imagenesInicio/GPU.webp",
      ...
      const producto12 = new Products(
        "$26.999",
        16,
        "../imagenes/imagenesInicio/motherboardbarata-destacado.webp",
      ...
      const producto13 = new Products(
        "$3.999",
        16,
        "../imagenes/imagenesInicio/reloj-destacado.webp",
      ...
      const producto14 = new Products(
        "$180.999",
        26,
        "../imagenes/imagenesInicio/rtx 2080ti.webp",
      ...
      const producto15 = new Products(
        "$5.999",
        26,
        "../imagenes/imagenesInicio/ssd.webp",
      ...
      const producto16 = new Products(
        "$85.099",
        26,
        "../imagenes/imagenesInicio/indice.webp",
